    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-950 to-black text-white">
      ...
      <section className="relative flex flex-col items-center justify-center text-center pt-40 pb-24 px-6 overflow-hidden">
        ...
        <motion.div
          ...
          className="w-40 h-40 rounded-full border-4 border-primary shadow-2xl mb-6 overflow-hidden"
        >
          <img
            src={DineshPhoto}
            alt="Dinesh"
        ...
        <p className="text-slate-300 max-w-2xl text-lg">
          Building scalable platforms, AI-powered applications, and real-time
          systems using modern JavaScript architecture.
        </p>

        <div className="flex gap-6 mt-8 text-xl">
          <a
            href="https://github.com/Dineshk-connect"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://linkedin.com/in/connectdinesh"
            target="_blank"
            rel="noreferrer"
          >
            <FaLinkedin className="hover:text-primary transition" />
          </a>
          <a href="/DINESH K RESUME .pdf" download>
      ...
      <section id="about" className="max-w-5xl mx-auto px-6 py-16">
        ...
        <p className="text-slate-300 leading-relaxed">
          ...
          Experienced in REST APIs, JWT authentication, Firebase Auth, real-time
          communication with Socket.io, and LLM-based API integration.
        </p>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-slate-400 text-sm">
                Built AI-driven platforms using Gemini API with persistent chat
                memory, structured prompt workflows, and dynamic recommendation
                systems.
              </p>
            </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="bg-slate-800/40 backdrop-blur-lg p-6 rounded-2xl border border-slate-700 transition hover:border-primary hover:-translate-y-1">
          ...
          <SkillBlock
            title="AI & Tools"
            skills={["Gemini API", "LLM Workflows", "Git", "Postman"]}
          />
        </div>
      </section>
      ...
      <section id="projects" className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <ProjectCard
            title="DevComrades"
            description="Real-time developer networking platform with 1–1 chat and secure auth."
...
<section id="experience" className="max-w-5xl mx-auto px-6 py-16">
  ...
  <div className="relative border-l border-slate-700 pl-10 space-y-12">
    ...
    <div className="relative">
      <div className="absolute -left-[18px] top-1 w-4 h-4 bg-primary rounded-full border-4 border-slate-900"></div>

      <h3 className="text-xl font-semibold">
        Software Development Intern (Remote) — Mobilean Technologies
      </h3>

      <p className="text-slate-300 text-sm mt-2 leading-relaxed">
        Contributing to web and mobile application development initiatives with
        exposure to IoT solutions and Generative AI concepts. Gaining practical
        experience with Oracle Cloud infrastructure and enterprise-oriented
        development workflows in a remote collaborative environment.
      </p>
    ...
    <div className="relative">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-primary/10 to-accent/10 border border-slate-700 rounded-2xl p-12 backdrop-blur-lg">
          ...
          <p className="text-slate-400 mb-8">
            Open to full-time software engineering roles and AI-focused product
            teams.
          </p>

          <a
            href="/DINESH K RESUME .pdf"
            download
      ...
      <section id="contact" className="text-center py-16 px-6">
        ...
        <p className="text-slate-400 mb-6">
          Open to full-time opportunities, collaborations, and AI-driven
          projects.
        </p>

       <div className="flex justify-center gap-4 mt-6">
  <a
    href="https://mail.google.com/mail/?view=cm&fs=1&to=dinesh.k.connect@gmail.com"
    target="_blank"
    rel="noopener noreferrer"
    className="bg-primary px-6 py-3 rounded-full font-semibold hover:opacity-90 transition"
  >
    Email Me
  </a>
  ...
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="border border-primary px-6 py-3 rounded-full font-semibold hover:bg-primary hover:text-white transition"
  >
    LinkedIn
  </a>
</div>
      ...
      <div className="flex gap-4 relative z-10">
        {github && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-sm bg-primary px-4 py-2 rounded-full hover:bg-accent transition"
          >
            GitHub
          </a>
        )}
        ...
        {live && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-sm border border-slate-600 px-4 py-2 rounded-full hover:border-primary transition"
          >
            Live Demo
          </a>
        )}
